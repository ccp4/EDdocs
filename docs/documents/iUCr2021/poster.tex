...
%%% Global Settings %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\graphicspath{{pix/}{fig/}}	% Root directory of the pictures
...
\definecolor{eqcolor}{RGB}{180,230,250}
...
\headerbox{Multislice(MS) method ~\cite{Kirkland2019}}{name=multi,column=1,span=1}{
	...
	\vspace{0.65em}\\
	\begin{tabular}{@{}c@{ }c@{ }c@{ }}
		\includegraphics[width=0.49\linewidth]{fig/multislice/multi2D/multi2D_Q.png}&
		\includegraphics[width=0.49\linewidth]{fig/multislice/multi2D/multi2D_Z.png}\\
...
Padded simulation for a IRELOH  : % found in continuous rotation experiment:
	...
	\begin{tabular}{@{}c@{ }c@{ }c@{ }}
		\includegraphics[width=0.49\linewidth]{fig/multislice/ireloh/multislice_ireloh_xy.png}&
		\includegraphics[width=0.49\linewidth]{fig/bloch/bloch_Iz.png}\\
...
\headerbox{Blochwave(BW) approach~\cite{Zuo1995}}{name=bloch,column=2,span=1}{
	...
	\begin{tabular}{@{}c@{ }c@{ }c@{ }}
		\includegraphics[width=0.49\linewidth]{fig/bloch/bloch_Sw.png}&
		\includegraphics[width=0.49\linewidth]{fig/bloch/bloch_Iz.png}\\
 ...
 Rocking curves for diamond in different configurations :
	...
	\begin{tabular}{@{}c@{ }c@{ }c@{ }}
		\includegraphics[width=0.49\linewidth]{fig/bloch/diamond_rock2.png}&
		\includegraphics[width=0.49\linewidth]{fig/bloch/diamond_rock1.png}\\
...
\begin{tabular}{@{}c@{ }c@{ }c@{ }c@{ }c@{ }}
	\hspace{1.5em}
	\includegraphics[width=0.4\linewidth]{fig/glycine/glycine_theta_Sw.png}&
	\includegraphics[width=0.4\linewidth]{fig/glycine/glycine_ref_beams5.png}\\
...
\begin{tabular}{@{}c@{ }c@{ }c@{ }c@{ }c@{ }}
	\hspace{1.5em}
	\includegraphics[width=0.4\linewidth]{fig/glycine/glycine_Iframe.png}&
	\includegraphics[width=0.4\linewidth]{fig/glycine/glycine_Ihkl.png}\\
...
This research was supported by BBSRC grant 4576434 WP4. The supports are gratefully acknowledged.
}
\end{poster}
\end{document}
