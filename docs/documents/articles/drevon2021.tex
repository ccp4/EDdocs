...
\begin{figure}
  \centering
  \includegraphics[height=0.35\textheight]{figures/Tmatrix.png}
...
\begin{figure}[h!]
  \centering
  \subfloat[]{\includegraphics[height=0.25\textwidth]{figures/addth_error.png}\label{fig:TmatrixError1}}
...
\begin{figure}[h!]
  \centering
  \subfloat[]{\includegraphics[height=0.39\textwidth]{figures/qdotSphereSingle_shells_pot1.eps}
  \label{fig:IAMa}}\\
  \vspace{-2em}
  \subfloat[]{\includegraphics[height=0.35\textwidth]{figures/qdotSphereSingle_shells_fka1.eps}
  \label{fig:IAMb}}
\caption{
...
\begin{figure}[h!]
  \centering
  \subfloat[]{\includegraphics[height=0.35\textwidth]{figures/TmatrixSingleS.eps}\label{fig:TmatrixSingleS}}\\
  \vspace{-2em}
  \subfloat[]{\includegraphics[height=0.35\textwidth]{figures/TmatrixSingleF.eps}\label{fig:TmatrixSingleF}}\\
\caption{
...
\begin{figure}[h!]
  \centering
  \subfloat[]{\includegraphics[height=0.3\textwidth]{figures/qdotSphereArray2approx_kakp_uncoupled.png}\label{fig:TmatrixApproxKinematic}}
  \subfloat[]{\includegraphics[height=0.3\textwidth]{figures/qdotSphereArray2approx_kakp_forward.png}\label{fig:TmatrixApproxForward}}
...
\begin{figure}[h!]
  \centering
  \subfloat[]{\includegraphics[height=0.35\textwidth]{figures/qdotSphereArray2approx_kakp_forward.png}\label{fig:TmatrixApproxSecondary}}\\
  \vspace{-2em}
  \subfloat[]{\includegraphics[height=0.35\textwidth]{figures/qdotSphereArrayNapprox_err_kp2.pdf}\label{fig:TmatrixApproxErr}}
\caption{
...
Both the kinematic and forward scattering approximation work slightly better with
...
\begin{figure}[h!]
  \centering
  \subfloat[]{\includegraphics[height=0.35\textwidth]{figures/dummy.eps}\label{fig:sigma_N}}\\
  \vspace{-2em}
  \subfloat[]{\includegraphics[height=0.35\textwidth]{figures/dummy.eps}\label{fig:f_n}}
  \caption{
