...
\begin{figure}[h!]
  \centering
  \subfloat[]{\includegraphics[height=\figsca\textwidth]{figures/dummy.eps}\label{fig:TmatrixApproxSecondary}}\\
  \vspace{-1.1em}
  \subfloat[]{\includegraphics[height=\figsca\textwidth]{figures/qdotSphereArray2approx_kakp_err_kp3.eps}\label{fig:TmatrixApproxErr}}
\caption{
